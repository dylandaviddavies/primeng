    ...
    template: `
        ...
        <div class="doc-section-code">
            <div class="doc-section-code-buttons scalein animation-duration-300">
                @if (fullCodeVisible) { @if (code.html) {
                ...
                <button pTooltip="Edit in StackBlitz" tooltipPosition="bottom" tooltipStyleClass="doc-section-code-tooltip" class="h-2rem w-2rem p-0 inline-flex align-items-center justify-content-center" (click)="openStackBlitz()">
